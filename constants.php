...
$pp_config = array(
    ...
    'address_override'  => 1,
    'currency_code'     => "USD",
    'return'            => "http://yourwebsite.com/store/index.php",
    'cancel_return'     => "http://yourwebsite.com/store/",
    'notify_url'        => "http://yourwebsite.com/store/pp_ipn.php",
    'cpp_header_image'  => "http://yourwebsite.com/store/assets/img/logo.png"
);
